...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/yachalk-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15074&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/yachalk-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `yachalk` can be installed with:

```
conda install yachalk
```

It is possible to list all of the versions of `yachalk` available on your platform with:
